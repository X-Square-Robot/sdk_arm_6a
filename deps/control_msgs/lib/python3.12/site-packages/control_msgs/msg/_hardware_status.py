...
class Metaclass_HardwareStatus(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if HardwareDeviceStatus.__class__._TYPE_SUPPORT is None:
                HardwareDeviceStatus.__class__.__import_type_support__()
...
class HardwareStatus(metaclass=Metaclass_HardwareStatus):
    ...
    _fields_and_field_types = {
        ...
        'hardware_id': 'string',
        'hardware_device_states': 'sequence<control_msgs/HardwareDeviceStatus>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['control_msgs', 'msg'], 'HardwareDeviceStatus')),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.hardware_device_states = kwargs.get('hardware_device_states', [])
    ...
    def __eq__(self, other):
        ...
        if self.hardware_id != other.hardware_id:
            return False
        if self.hardware_device_states != other.hardware_device_states:
            return False
        return True
    ...
    @builtins.property
    def hardware_device_states(self):
        """Message field 'hardware_device_states'."""
        return self._hardware_device_states

    @hardware_device_states.setter
    def hardware_device_states(self, value):
        if self._check_fields:
            from control_msgs.msg import HardwareDeviceStatus
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, HardwareDeviceStatus) for v in value) and
                 True), \
                "The 'hardware_device_states' field must be a set or sequence and each value of type 'HardwareDeviceStatus'"
        self._hardware_device_states = value
