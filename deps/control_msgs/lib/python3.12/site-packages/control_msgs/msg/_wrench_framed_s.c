...
bool control_msgs__msg__wrench_framed__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("control_msgs.msg._wrench_framed.WrenchFramed", full_classname_dest, 44) == 0);
  }
  control_msgs__msg__WrenchFramed * ros_message = _ros_message;
  {  // frame_id
...
{
  /* NOTE(esteve): Call constructor of WrenchFramed */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("control_msgs.msg._wrench_framed");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WrenchFramed");
