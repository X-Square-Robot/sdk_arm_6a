...
bool control_msgs__msg__pid_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // p_gain
    ...
    assert(PyFloat_Check(field));
    ros_message->p_gain = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // i_gain
    ...
    assert(PyFloat_Check(field));
    ros_message->i_gain = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // d_gain
    ...
    assert(PyFloat_Check(field));
    ros_message->d_gain = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // output
...
PyObject * control_msgs__msg__pid_state__convert_to_py(void * raw_ros_message)
{
  ...
  {  // i_gain
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->i_gain);
    {
  ...
  {  // d_gain
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->d_gain);
    {
