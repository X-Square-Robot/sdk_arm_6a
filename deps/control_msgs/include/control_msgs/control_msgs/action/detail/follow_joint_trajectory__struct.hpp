...
struct FollowJointTrajectory_Feedback_
{
  ...
  using _multi_dof_index_type =
    int32_t;
  _multi_dof_index_type multi_dof_index;
  ...
  Type & set__multi_dof_index(
    const int32_t & _arg)
  {
    this->multi_dof_index = _arg;
    return *this;
  }
  ...
  bool operator==(const FollowJointTrajectory_Feedback_ & other) const
  {
    ...
    if (this->multi_dof_index != other.multi_dof_index) {
      return false;
    }
    return true;
  }
