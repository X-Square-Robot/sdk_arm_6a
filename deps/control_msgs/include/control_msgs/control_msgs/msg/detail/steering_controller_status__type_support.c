...
size_t control_msgs__msg__SteeringControllerStatus__rosidl_typesupport_introspection_c__size_function__SteeringControllerStatus__traction_command(
  const void * untyped_member)
{
  const rosidl_runtime_c__double__Sequence * member =
    (const rosidl_runtime_c__double__Sequence *)(untyped_member);
...
const void * control_msgs__msg__SteeringControllerStatus__rosidl_typesupport_introspection_c__get_const_function__SteeringControllerStatus__traction_command(
  const void * untyped_member, size_t index)
{
  const rosidl_runtime_c__double__Sequence * member =
    (const rosidl_runtime_c__double__Sequence *)(untyped_member);
...
void * control_msgs__msg__SteeringControllerStatus__rosidl_typesupport_introspection_c__get_function__SteeringControllerStatus__traction_command(
  void * untyped_member, size_t index)
{
  rosidl_runtime_c__double__Sequence * member =
    (rosidl_runtime_c__double__Sequence *)(untyped_member);
...
void control_msgs__msg__SteeringControllerStatus__rosidl_typesupport_introspection_c__fetch_function__SteeringControllerStatus__traction_command(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const double * item =
    ((const double *)
    control_msgs__msg__SteeringControllerStatus__rosidl_typesupport_introspection_c__get_const_function__SteeringControllerStatus__traction_command(untyped_member, index));
  double * value =
    (double *)(untyped_value);
  *value = *item;
}

void control_msgs__msg__SteeringControllerStatus__rosidl_typesupport_introspection_c__assign_function__SteeringControllerStatus__traction_command(
  void * untyped_member, size_t index, const void * untyped_value)
{
  double * item =
    ((double *)
    control_msgs__msg__SteeringControllerStatus__rosidl_typesupport_introspection_c__get_function__SteeringControllerStatus__traction_command(untyped_member, index));
  const double * value =
    (const double *)(untyped_value);
  *item = *value;
}

bool control_msgs__msg__SteeringControllerStatus__rosidl_typesupport_introspection_c__resize_function__SteeringControllerStatus__traction_command(
  void * untyped_member, size_t size)
{
  rosidl_runtime_c__double__Sequence * member =
    (rosidl_runtime_c__double__Sequence *)(untyped_member);
...
static rosidl_typesupport_introspection_c__MessageMember control_msgs__msg__SteeringControllerStatus__rosidl_typesupport_introspection_c__SteeringControllerStatus_message_member_array[6] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control_msgs__msg__SteeringControllerStatus, traction_command),  // bytes offset in struct
    NULL,  // default value
    control_msgs__msg__SteeringControllerStatus__rosidl_typesupport_introspection_c__size_function__SteeringControllerStatus__traction_command,  // size() function pointer
    control_msgs__msg__SteeringControllerStatus__rosidl_typesupport_introspection_c__get_const_function__SteeringControllerStatus__traction_command,  // get_const(index) function pointer
    control_msgs__msg__SteeringControllerStatus__rosidl_typesupport_introspection_c__get_function__SteeringControllerStatus__traction_command,  // get(index) function pointer
    control_msgs__msg__SteeringControllerStatus__rosidl_typesupport_introspection_c__fetch_function__SteeringControllerStatus__traction_command,  // fetch(index, &value) function pointer
    control_msgs__msg__SteeringControllerStatus__rosidl_typesupport_introspection_c__assign_function__SteeringControllerStatus__traction_command,  // assign(index, value) function pointer
    control_msgs__msg__SteeringControllerStatus__rosidl_typesupport_introspection_c__resize_function__SteeringControllerStatus__traction_command  // resize(index) function pointer
  },
  {
