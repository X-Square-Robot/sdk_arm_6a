...
struct SteeringControllerStatus_
{
  ...
  using _traction_command_type =
    std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>>;
  _traction_command_type traction_command;
  ...
  Type & set__traction_command(
    const std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> & _arg)
  {
    this->traction_command = _arg;
    return *this;
  }
  ...
  bool operator==(const SteeringControllerStatus_ & other) const
  {
    ...
    if (this->traction_command != other.traction_command) {
      return false;
    }
