...
// IWYU pragma: private, include "control_msgs/msg/steering_controller_status.hpp"
...
class Init_SteeringControllerStatus_traction_command
{
public:
  explicit Init_SteeringControllerStatus_traction_command(::control_msgs::msg::SteeringControllerStatus & msg)
  : msg_(msg)
  {}
  Init_SteeringControllerStatus_steering_angle_command traction_command(::control_msgs::msg::SteeringControllerStatus::_traction_command_type arg)
  {
    msg_.traction_command = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_SteeringControllerStatus_traction_command steer_positions(::control_msgs::msg::SteeringControllerStatus::_steer_positions_type arg)
  {
    msg_.steer_positions = std::move(arg);
    return Init_SteeringControllerStatus_traction_command(msg_);
  }
