...
size_t size_function__SteeringControllerStatus__traction_command(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<double> *>(untyped_member);
  return member->size();
}

const void * get_const_function__SteeringControllerStatus__traction_command(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<double> *>(untyped_member);
  return &member[index];
...
void * get_function__SteeringControllerStatus__traction_command(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<double> *>(untyped_member);
  return &member[index];
...
void fetch_function__SteeringControllerStatus__traction_command(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const double *>(
    get_const_function__SteeringControllerStatus__traction_command(untyped_member, index));
  auto & value = *reinterpret_cast<double *>(untyped_value);
  value = item;
}

void assign_function__SteeringControllerStatus__traction_command(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<double *>(
    get_function__SteeringControllerStatus__traction_command(untyped_member, index));
  const auto & value = *reinterpret_cast<const double *>(untyped_value);
  item = value;
}

void resize_function__SteeringControllerStatus__traction_command(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<double> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SteeringControllerStatus_message_member_array[6] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control_msgs::msg::SteeringControllerStatus, traction_command),  // bytes offset in struct
    nullptr,  // default value
    size_function__SteeringControllerStatus__traction_command,  // size() function pointer
    get_const_function__SteeringControllerStatus__traction_command,  // get_const(index) function pointer
    get_function__SteeringControllerStatus__traction_command,  // get(index) function pointer
    fetch_function__SteeringControllerStatus__traction_command,  // fetch(index, &value) function pointer
    assign_function__SteeringControllerStatus__traction_command,  // assign(index, value) function pointer
    resize_function__SteeringControllerStatus__traction_command  // resize(index) function pointer
  },
  {
