...
static char control_msgs__msg__HardwareDeviceDiagnostics__FIELD_NAME__header[] = "header";
static char control_msgs__msg__HardwareDeviceDiagnostics__FIELD_NAME__device_id[] = "device_id";
static char control_msgs__msg__HardwareDeviceDiagnostics__FIELD_NAME__entries[] = "entries";

static rosidl_runtime_c__type_description__Field control_msgs__msg__HardwareDeviceDiagnostics__FIELDS[] = {
  {
    {control_msgs__msg__HardwareDeviceDiagnostics__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {control_msgs__msg__HardwareDeviceDiagnostics__FIELD_NAME__device_id, 9, 9},
    {
  ...
  {
    {control_msgs__msg__HardwareDeviceDiagnostics__FIELD_NAME__entries, 7, 7},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription control_msgs__msg__HardwareDeviceDiagnostics__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {control_msgs__msg__HardwareDeviceDiagnostics__FIELDS, 3, 3},
    },
    {control_msgs__msg__HardwareDeviceDiagnostics__REFERENCED_TYPE_DESCRIPTIONS, 3, 3},
  };
  if (!constructed) {
...
control_msgs__msg__HardwareDeviceDiagnostics__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *control_msgs__msg__HardwareDeviceDiagnostics__get_individual_type_description_source(NULL),
