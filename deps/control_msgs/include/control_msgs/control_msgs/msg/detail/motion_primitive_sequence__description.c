...
static char control_msgs__msg__MotionPrimitiveSequence__FIELD_NAME__motions[] = "motions";

static rosidl_runtime_c__type_description__Field control_msgs__msg__MotionPrimitiveSequence__FIELDS[] = {
  {
    {control_msgs__msg__MotionPrimitiveSequence__FIELD_NAME__motions, 7, 7},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription control_msgs__msg__MotionPrimitiveSequence__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {control_msgs__msg__MotionPrimitiveSequence__FIELDS, 1, 1},
    },
    {control_msgs__msg__MotionPrimitiveSequence__REFERENCED_TYPE_DESCRIPTIONS, 8, 8},
  };
  if (!constructed) {
...
control_msgs__msg__MotionPrimitiveSequence__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *control_msgs__msg__MotionPrimitiveSequence__get_individual_type_description_source(NULL),
