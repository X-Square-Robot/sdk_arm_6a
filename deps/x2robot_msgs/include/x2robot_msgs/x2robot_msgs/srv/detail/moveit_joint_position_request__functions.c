...
x2robot_msgs__srv__MoveitJointPositionRequest_Request__init(x2robot_msgs__srv__MoveitJointPositionRequest_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__Sequence__init(&msg->joint_names, 0)) {
    x2robot_msgs__srv__MoveitJointPositionRequest_Request__fini(msg);
    return false;
  }
  // joint_positions
...
x2robot_msgs__srv__MoveitJointPositionRequest_Request__create(void)
{
  ...
  x2robot_msgs__srv__MoveitJointPositionRequest_Request * msg = (x2robot_msgs__srv__MoveitJointPositionRequest_Request *)allocator.allocate(sizeof(x2robot_msgs__srv__MoveitJointPositionRequest_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(x2robot_msgs__srv__MoveitJointPositionRequest_Request));
  bool success = x2robot_msgs__srv__MoveitJointPositionRequest_Request__init(msg);
  if (!success) {
...
x2robot_msgs__srv__MoveitJointPositionRequest_Request__Sequence__init(x2robot_msgs__srv__MoveitJointPositionRequest_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  x2robot_msgs__srv__MoveitJointPositionRequest_Request * data = NULL;

  if (size) {
    data = (x2robot_msgs__srv__MoveitJointPositionRequest_Request *)allocator.zero_allocate(size, sizeof(x2robot_msgs__srv__MoveitJointPositionRequest_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = x2robot_msgs__srv__MoveitJointPositionRequest_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        x2robot_msgs__srv__MoveitJointPositionRequest_Request__fini(&data[i - 1]);
      }
...
x2robot_msgs__srv__MoveitJointPositionRequest_Request__Sequence__fini(x2robot_msgs__srv__MoveitJointPositionRequest_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      x2robot_msgs__srv__MoveitJointPositionRequest_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  x2robot_msgs__srv__MoveitJointPositionRequest_Request__Sequence * array = (x2robot_msgs__srv__MoveitJointPositionRequest_Request__Sequence *)allocator.allocate(sizeof(x2robot_msgs__srv__MoveitJointPositionRequest_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = x2robot_msgs__srv__MoveitJointPositionRequest_Request__Sequence__init(array, size);
  if (!success) {
...
x2robot_msgs__srv__MoveitJointPositionRequest_Request__Sequence__destroy(x2robot_msgs__srv__MoveitJointPositionRequest_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    x2robot_msgs__srv__MoveitJointPositionRequest_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
x2robot_msgs__srv__MoveitJointPositionRequest_Request__Sequence__are_equal(const x2robot_msgs__srv__MoveitJointPositionRequest_Request__Sequence * lhs, const x2robot_msgs__srv__MoveitJointPositionRequest_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!x2robot_msgs__srv__MoveitJointPositionRequest_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  x2robot_msgs__srv__MoveitJointPositionRequest_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(x2robot_msgs__srv__MoveitJointPositionRequest_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    x2robot_msgs__srv__MoveitJointPositionRequest_Request * data =
      (x2robot_msgs__srv__MoveitJointPositionRequest_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!x2robot_msgs__srv__MoveitJointPositionRequest_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          x2robot_msgs__srv__MoveitJointPositionRequest_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!x2robot_msgs__srv__MoveitJointPositionRequest_Request__copy(
...
x2robot_msgs__srv__MoveitJointPositionRequest_Response__init(x2robot_msgs__srv__MoveitJointPositionRequest_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    x2robot_msgs__srv__MoveitJointPositionRequest_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  x2robot_msgs__srv__MoveitJointPositionRequest_Response * msg = (x2robot_msgs__srv__MoveitJointPositionRequest_Response *)allocator.allocate(sizeof(x2robot_msgs__srv__MoveitJointPositionRequest_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(x2robot_msgs__srv__MoveitJointPositionRequest_Response));
  bool success = x2robot_msgs__srv__MoveitJointPositionRequest_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
x2robot_msgs__srv__MoveitJointPositionRequest_Response__Sequence__init(x2robot_msgs__srv__MoveitJointPositionRequest_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  x2robot_msgs__srv__MoveitJointPositionRequest_Response * data = NULL;

  if (size) {
    data = (x2robot_msgs__srv__MoveitJointPositionRequest_Response *)allocator.zero_allocate(size, sizeof(x2robot_msgs__srv__MoveitJointPositionRequest_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = x2robot_msgs__srv__MoveitJointPositionRequest_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        x2robot_msgs__srv__MoveitJointPositionRequest_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
x2robot_msgs__srv__MoveitJointPositionRequest_Response__Sequence__fini(x2robot_msgs__srv__MoveitJointPositionRequest_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      x2robot_msgs__srv__MoveitJointPositionRequest_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  x2robot_msgs__srv__MoveitJointPositionRequest_Response__Sequence * array = (x2robot_msgs__srv__MoveitJointPositionRequest_Response__Sequence *)allocator.allocate(sizeof(x2robot_msgs__srv__MoveitJointPositionRequest_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = x2robot_msgs__srv__MoveitJointPositionRequest_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
x2robot_msgs__srv__MoveitJointPositionRequest_Response__Sequence__destroy(x2robot_msgs__srv__MoveitJointPositionRequest_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    x2robot_msgs__srv__MoveitJointPositionRequest_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
x2robot_msgs__srv__MoveitJointPositionRequest_Response__Sequence__are_equal(const x2robot_msgs__srv__MoveitJointPositionRequest_Response__Sequence * lhs, const x2robot_msgs__srv__MoveitJointPositionRequest_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!x2robot_msgs__srv__MoveitJointPositionRequest_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  x2robot_msgs__srv__MoveitJointPositionRequest_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(x2robot_msgs__srv__MoveitJointPositionRequest_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    x2robot_msgs__srv__MoveitJointPositionRequest_Response * data =
      (x2robot_msgs__srv__MoveitJointPositionRequest_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!x2robot_msgs__srv__MoveitJointPositionRequest_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          x2robot_msgs__srv__MoveitJointPositionRequest_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!x2robot_msgs__srv__MoveitJointPositionRequest_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
x2robot_msgs__srv__MoveitJointPositionRequest_Event__init(x2robot_msgs__srv__MoveitJointPositionRequest_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    x2robot_msgs__srv__MoveitJointPositionRequest_Event__fini(msg);
    return false;
  }
  // request
  if (!x2robot_msgs__srv__MoveitJointPositionRequest_Request__Sequence__init(&msg->request, 0)) {
    x2robot_msgs__srv__MoveitJointPositionRequest_Event__fini(msg);
    return false;
  }
  // response
  if (!x2robot_msgs__srv__MoveitJointPositionRequest_Response__Sequence__init(&msg->response, 0)) {
    x2robot_msgs__srv__MoveitJointPositionRequest_Event__fini(msg);
    return false;
  }
  return true;
...
x2robot_msgs__srv__MoveitJointPositionRequest_Event__fini(x2robot_msgs__srv__MoveitJointPositionRequest_Event * msg)
{
  ...
  // request
  x2robot_msgs__srv__MoveitJointPositionRequest_Request__Sequence__fini(&msg->request);
  // response
  x2robot_msgs__srv__MoveitJointPositionRequest_Response__Sequence__fini(&msg->response);
}
...
x2robot_msgs__srv__MoveitJointPositionRequest_Event__are_equal(const x2robot_msgs__srv__MoveitJointPositionRequest_Event * lhs, const x2robot_msgs__srv__MoveitJointPositionRequest_Event * rhs)
{
  ...
  // request
  if (!x2robot_msgs__srv__MoveitJointPositionRequest_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!x2robot_msgs__srv__MoveitJointPositionRequest_Response__Sequence__are_equal(
  ...
  x2robot_msgs__srv__MoveitJointPositionRequest_Event * output)
{
  ...
  // request
  if (!x2robot_msgs__srv__MoveitJointPositionRequest_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!x2robot_msgs__srv__MoveitJointPositionRequest_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  x2robot_msgs__srv__MoveitJointPositionRequest_Event * msg = (x2robot_msgs__srv__MoveitJointPositionRequest_Event *)allocator.allocate(sizeof(x2robot_msgs__srv__MoveitJointPositionRequest_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(x2robot_msgs__srv__MoveitJointPositionRequest_Event));
  bool success = x2robot_msgs__srv__MoveitJointPositionRequest_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
x2robot_msgs__srv__MoveitJointPositionRequest_Event__Sequence__init(x2robot_msgs__srv__MoveitJointPositionRequest_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  x2robot_msgs__srv__MoveitJointPositionRequest_Event * data = NULL;

  if (size) {
    data = (x2robot_msgs__srv__MoveitJointPositionRequest_Event *)allocator.zero_allocate(size, sizeof(x2robot_msgs__srv__MoveitJointPositionRequest_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = x2robot_msgs__srv__MoveitJointPositionRequest_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        x2robot_msgs__srv__MoveitJointPositionRequest_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
x2robot_msgs__srv__MoveitJointPositionRequest_Event__Sequence__fini(x2robot_msgs__srv__MoveitJointPositionRequest_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      x2robot_msgs__srv__MoveitJointPositionRequest_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  x2robot_msgs__srv__MoveitJointPositionRequest_Event__Sequence * array = (x2robot_msgs__srv__MoveitJointPositionRequest_Event__Sequence *)allocator.allocate(sizeof(x2robot_msgs__srv__MoveitJointPositionRequest_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = x2robot_msgs__srv__MoveitJointPositionRequest_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
x2robot_msgs__srv__MoveitJointPositionRequest_Event__Sequence__destroy(x2robot_msgs__srv__MoveitJointPositionRequest_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    x2robot_msgs__srv__MoveitJointPositionRequest_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
x2robot_msgs__srv__MoveitJointPositionRequest_Event__Sequence__are_equal(const x2robot_msgs__srv__MoveitJointPositionRequest_Event__Sequence * lhs, const x2robot_msgs__srv__MoveitJointPositionRequest_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!x2robot_msgs__srv__MoveitJointPositionRequest_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  x2robot_msgs__srv__MoveitJointPositionRequest_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(x2robot_msgs__srv__MoveitJointPositionRequest_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    x2robot_msgs__srv__MoveitJointPositionRequest_Event * data =
      (x2robot_msgs__srv__MoveitJointPositionRequest_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!x2robot_msgs__srv__MoveitJointPositionRequest_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          x2robot_msgs__srv__MoveitJointPositionRequest_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!x2robot_msgs__srv__MoveitJointPositionRequest_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
