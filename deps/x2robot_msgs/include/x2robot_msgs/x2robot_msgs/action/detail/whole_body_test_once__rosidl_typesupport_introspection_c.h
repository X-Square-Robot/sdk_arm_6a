...
#ifndef X2ROBOT_MSGS__ACTION__DETAIL__WHOLE_BODY_TEST_ONCE__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
#define X2ROBOT_MSGS__ACTION__DETAIL__WHOLE_BODY_TEST_ONCE__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, x2robot_msgs, action, WholeBodyTestOnce_SendGoal)();
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_PUBLIC_x2robot_msgs
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, x2robot_msgs, action, WholeBodyTestOnce_GetResult)();
...
#endif  // X2ROBOT_MSGS__ACTION__DETAIL__WHOLE_BODY_TEST_ONCE__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
