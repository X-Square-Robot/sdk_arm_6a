...
bool x2robot_msgs__msg__servo_drive_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("x2robot_msgs.msg._servo_drive_state.ServoDriveState", full_classname_dest, 51) == 0);
  }
  x2robot_msgs__msg__ServoDriveState * ros_message = _ros_message;
  {  // stamp
  ...
  {  // error_codes
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      if (!rosidl_runtime_c__uint32__Sequence__init(&(ros_message->error_codes), size)) {
        PyErr_SetString(PyExc_RuntimeError, "unable to create uint32__Sequence ros_message");
        PyBuffer_Release(&view);
        Py_DECREF(field);
        return false;
      }
      uint32_t * dest = ros_message->error_codes.data;
...
{
  /* NOTE(esteve): Call constructor of ServoDriveState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("x2robot_msgs.msg._servo_drive_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ServoDriveState");
  ...
  {  // error_codes
    ...
    if (ros_message->error_codes.size > 0) {
      ...
      uint32_t * src = &(ros_message->error_codes.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->error_codes.size * sizeof(uint32_t));
      assert(data != NULL);
