...
bool x2robot_msgs__msg__serial_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("x2robot_msgs.msg._serial_data.SerialData", full_classname_dest, 40) == 0);
  }
  x2robot_msgs__msg__SerialData * ros_message = _ros_message;
  {  // stamp
  ...
  {  // cmd_id
    ...
    assert(PyLong_Check(field));
    ros_message->cmd_id = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // payload
...
PyObject * x2robot_msgs__msg__serial_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("x2robot_msgs.msg._serial_data");
