...
class Metaclass_ServoDriveState(type):
    """Metaclass of message 'ServoDriveState'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__servo_drive_state
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__servo_drive_state
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__servo_drive_state
            cls._TYPE_SUPPORT = module.type_support_msg__msg__servo_drive_state
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__servo_drive_state
...
class ServoDriveState(metaclass=Metaclass_ServoDriveState):
    """Message class 'ServoDriveState'."""
    ...
    def error_codes(self, value):
        if self._check_fields:
            ...
            assert \
                ...
                "The 'error_codes' field must be a set or sequence and each value of type 'int' and each unsigned integer in [0, 4294967295]"
