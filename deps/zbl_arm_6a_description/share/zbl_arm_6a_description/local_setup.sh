...
: ${AMENT_CURRENT_PREFIX:="/opt/xr/core/install/zbl_arm_6a_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/zbl_arm_6a_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/zbl_arm_6a_description/environment/path.sh"
