...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
  ...
  public:
    ...
    void declare_params(){
      ...
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "interface_names.force.x") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.interface_names.force.x = param.as_string();
      param = parameters_interface_->get_parameter(prefix_ + "interface_names.force.y");
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "interface_names.force.y") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.interface_names.force.y = param.as_string();
      param = parameters_interface_->get_parameter(prefix_ + "interface_names.force.z");
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "interface_names.force.z") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.interface_names.force.z = param.as_string();
      param = parameters_interface_->get_parameter(prefix_ + "interface_names.torque.x");
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "interface_names.torque.x") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.interface_names.torque.x = param.as_string();
      param = parameters_interface_->get_parameter(prefix_ + "interface_names.torque.y");
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "interface_names.torque.y") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.interface_names.torque.y = param.as_string();
      param = parameters_interface_->get_parameter(prefix_ + "interface_names.torque.z");
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "interface_names.torque.z") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.interface_names.torque.z = param.as_string();
      param = parameters_interface_->get_parameter(prefix_ + "offset.force.x");
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "offset.force.x") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.offset.force.x = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "offset.force.y");
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "offset.force.y") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.offset.force.y = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "offset.force.z");
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "offset.force.z") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.offset.force.z = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "offset.torque.x");
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "offset.torque.x") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.offset.torque.x = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "offset.torque.y");
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "offset.torque.y") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.offset.torque.y = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "offset.torque.z");
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "offset.torque.z") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.offset.torque.z = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "multiplier.force.x");
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "multiplier.force.x") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.multiplier.force.x = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "multiplier.force.y");
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "multiplier.force.y") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.multiplier.force.y = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "multiplier.force.z");
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "multiplier.force.z") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.multiplier.force.z = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "multiplier.torque.x");
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "multiplier.torque.x") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.multiplier.torque.x = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "multiplier.torque.y");
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "multiplier.torque.y") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.multiplier.torque.y = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "multiplier.torque.z");
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "multiplier.torque.z") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.multiplier.torque.z = param.as_double();
