...
: ${AMENT_CURRENT_PREFIX:="/opt/xr/core/install/x2robot_hardware_interface"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/x2robot_hardware_interface/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/x2robot_hardware_interface/environment/path.sh"
