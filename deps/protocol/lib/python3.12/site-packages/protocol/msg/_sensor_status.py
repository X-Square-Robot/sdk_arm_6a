...
class SensorStatus(metaclass=Metaclass_SensorStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.error_bit_code = kwargs.get('error_bit_code', int())
    ...
    def __eq__(self, other):
        ...
        if self.state_code != other.state_code:
            return False
        if self.error_bit_code != other.error_bit_code:
            return False
        return True
    ...
    @builtins.property
    def error_bit_code(self):
        """Message field 'error_bit_code'."""
        return self._error_bit_code

    @error_bit_code.setter
    def error_bit_code(self, value):
        if self._check_fields:
            assert \
                isinstance(value, int), \
                "The 'error_bit_code' field must be of type 'int'"
            assert value >= 0 and value < 4294967296, \
                "The 'error_bit_code' field must be an unsigned integer in [0, 4294967295]"
        self._error_bit_code = value
