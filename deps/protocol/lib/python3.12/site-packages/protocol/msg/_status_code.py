...
class Metaclass_StatusCode(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from protocol.msg import UnitError
            if UnitError.__class__._TYPE_SUPPORT is None:
                UnitError.__class__.__import_type_support__()
...
class StatusCode(metaclass=Metaclass_StatusCode):
    ...
    _fields_and_field_types = {
        ...
        'unit': 'uint8',
        'state_code': 'uint8',
        'error_code': 'sequence<protocol/UnitError>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['protocol', 'msg'], 'UnitError')),  # noqa: E501
    )
    ...
    def unit(self, value):
        if self._check_fields:
            ...
            assert value >= 0 and value < 256, \
                "The 'unit' field must be an unsigned integer in [0, 255]"
        self._unit = value
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, UnitError) for v in value) and
                 True), \
                "The 'error_code' field must be a set or sequence and each value of type 'UnitError'"
