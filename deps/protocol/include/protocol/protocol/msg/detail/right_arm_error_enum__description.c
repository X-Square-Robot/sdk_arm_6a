  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x00, 0xad, 0x35, 0x58, 0x2d, 0xc3, 0xe4, 0x3b,
      0x05, 0x20, 0xc2, 0xe3, 0x19, 0x08, 0xc1, 0xde,
      0x44, 0xaf, 0x18, 0xd1, 0x41, 0xaf, 0x8f, 0xfe,
      0xf7, 0x75, 0x7e, 0xfc, 0x96, 0xdb, 0xc1, 0x8d,
    }};
  return &hash;
}
...
static char protocol__msg__RightArmErrorEnum__TYPE_NAME[] = "protocol/msg/RightArmErrorEnum";

// Define type names, field names, and default values
static char protocol__msg__RightArmErrorEnum__FIELD_NAME__structure_needs_at_least_one_member[] = "structure_needs_at_least_one_member";

static rosidl_runtime_c__type_description__Field protocol__msg__RightArmErrorEnum__FIELDS[] = {
  {
    {protocol__msg__RightArmErrorEnum__FIELD_NAME__structure_needs_at_least_one_member, 35, 35},
    {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {protocol__msg__RightArmErrorEnum__TYPE_NAME, 30, 30},
      {protocol__msg__RightArmErrorEnum__FIELDS, 1, 1},
    },
    {NULL, 0, 0},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *protocol__msg__RightArmErrorEnum__get_individual_type_description_source(NULL),
    constructed = true;
  }
