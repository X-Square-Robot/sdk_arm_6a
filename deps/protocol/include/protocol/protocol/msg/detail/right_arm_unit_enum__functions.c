...
protocol__msg__RightArmUnitEnum__create(void)
{
  ...
  protocol__msg__RightArmUnitEnum * msg = (protocol__msg__RightArmUnitEnum *)allocator.allocate(sizeof(protocol__msg__RightArmUnitEnum), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(protocol__msg__RightArmUnitEnum));
  bool success = protocol__msg__RightArmUnitEnum__init(msg);
  if (!success) {
...
protocol__msg__RightArmUnitEnum__destroy(protocol__msg__RightArmUnitEnum * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    protocol__msg__RightArmUnitEnum__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
protocol__msg__RightArmUnitEnum__Sequence__init(protocol__msg__RightArmUnitEnum__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  protocol__msg__RightArmUnitEnum * data = NULL;

  if (size) {
    data = (protocol__msg__RightArmUnitEnum *)allocator.zero_allocate(size, sizeof(protocol__msg__RightArmUnitEnum), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = protocol__msg__RightArmUnitEnum__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        protocol__msg__RightArmUnitEnum__fini(&data[i - 1]);
      }
...
protocol__msg__RightArmUnitEnum__Sequence__fini(protocol__msg__RightArmUnitEnum__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      protocol__msg__RightArmUnitEnum__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  protocol__msg__RightArmUnitEnum__Sequence * array = (protocol__msg__RightArmUnitEnum__Sequence *)allocator.allocate(sizeof(protocol__msg__RightArmUnitEnum__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = protocol__msg__RightArmUnitEnum__Sequence__init(array, size);
  if (!success) {
...
protocol__msg__RightArmUnitEnum__Sequence__destroy(protocol__msg__RightArmUnitEnum__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    protocol__msg__RightArmUnitEnum__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
protocol__msg__RightArmUnitEnum__Sequence__are_equal(const protocol__msg__RightArmUnitEnum__Sequence * lhs, const protocol__msg__RightArmUnitEnum__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!protocol__msg__RightArmUnitEnum__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  protocol__msg__RightArmUnitEnum__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(protocol__msg__RightArmUnitEnum);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    protocol__msg__RightArmUnitEnum * data =
      (protocol__msg__RightArmUnitEnum *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!protocol__msg__RightArmUnitEnum__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          protocol__msg__RightArmUnitEnum__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!protocol__msg__RightArmUnitEnum__copy(
