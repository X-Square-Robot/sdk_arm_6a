  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xfc, 0xa0, 0xbb, 0x72, 0xba, 0x37, 0x0d, 0xa6,
      0x40, 0x6c, 0x07, 0x0b, 0x1f, 0xab, 0x21, 0xd9,
      0x4c, 0x99, 0x82, 0x7a, 0x10, 0xc9, 0x07, 0x21,
      0x8b, 0x45, 0xc6, 0x03, 0x9c, 0x7a, 0xb9, 0xee,
    }};
  return &hash;
}
...
static char protocol__msg__RealtimeControllerUnitEnum__TYPE_NAME[] = "protocol/msg/RealtimeControllerUnitEnum";

// Define type names, field names, and default values
static char protocol__msg__RealtimeControllerUnitEnum__FIELD_NAME__structure_needs_at_least_one_member[] = "structure_needs_at_least_one_member";

static rosidl_runtime_c__type_description__Field protocol__msg__RealtimeControllerUnitEnum__FIELDS[] = {
  {
    {protocol__msg__RealtimeControllerUnitEnum__FIELD_NAME__structure_needs_at_least_one_member, 35, 35},
    {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {protocol__msg__RealtimeControllerUnitEnum__TYPE_NAME, 39, 39},
      {protocol__msg__RealtimeControllerUnitEnum__FIELDS, 1, 1},
    },
    {NULL, 0, 0},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *protocol__msg__RealtimeControllerUnitEnum__get_individual_type_description_source(NULL),
    constructed = true;
  }
