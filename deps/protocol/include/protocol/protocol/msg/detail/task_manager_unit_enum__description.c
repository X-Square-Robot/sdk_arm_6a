  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x3e, 0x5d, 0x50, 0x12, 0xee, 0x6f, 0xa3, 0x81,
      0xe3, 0x40, 0x8a, 0xd3, 0x65, 0xb7, 0xdd, 0x96,
      0xb0, 0x02, 0x5e, 0xc6, 0x6c, 0x0d, 0x38, 0xbc,
      0xe2, 0xcb, 0x88, 0x03, 0xc1, 0xac, 0xf5, 0x6c,
    }};
  return &hash;
}
...
static char protocol__msg__TaskManagerUnitEnum__TYPE_NAME[] = "protocol/msg/TaskManagerUnitEnum";

// Define type names, field names, and default values
static char protocol__msg__TaskManagerUnitEnum__FIELD_NAME__structure_needs_at_least_one_member[] = "structure_needs_at_least_one_member";

static rosidl_runtime_c__type_description__Field protocol__msg__TaskManagerUnitEnum__FIELDS[] = {
  {
    {protocol__msg__TaskManagerUnitEnum__FIELD_NAME__structure_needs_at_least_one_member, 35, 35},
    {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {protocol__msg__TaskManagerUnitEnum__TYPE_NAME, 32, 32},
      {protocol__msg__TaskManagerUnitEnum__FIELDS, 1, 1},
    },
    {NULL, 0, 0},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *protocol__msg__TaskManagerUnitEnum__get_individual_type_description_source(NULL),
    constructed = true;
  }
