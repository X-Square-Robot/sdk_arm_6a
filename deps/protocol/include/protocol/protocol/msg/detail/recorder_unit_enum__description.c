  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xd6, 0x79, 0xac, 0x1b, 0xf4, 0x64, 0xf6, 0x87,
      0xf7, 0x4d, 0x3b, 0x9a, 0x13, 0x7a, 0x9b, 0x66,
      0x47, 0x3f, 0x3a, 0xc1, 0x50, 0xe7, 0xfb, 0x52,
      0xe7, 0x99, 0x33, 0xf9, 0x88, 0x35, 0x8a, 0x1d,
    }};
  return &hash;
}
...
static char protocol__msg__RecorderUnitEnum__TYPE_NAME[] = "protocol/msg/RecorderUnitEnum";

// Define type names, field names, and default values
static char protocol__msg__RecorderUnitEnum__FIELD_NAME__structure_needs_at_least_one_member[] = "structure_needs_at_least_one_member";

static rosidl_runtime_c__type_description__Field protocol__msg__RecorderUnitEnum__FIELDS[] = {
  {
    {protocol__msg__RecorderUnitEnum__FIELD_NAME__structure_needs_at_least_one_member, 35, 35},
    {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {protocol__msg__RecorderUnitEnum__TYPE_NAME, 29, 29},
      {protocol__msg__RecorderUnitEnum__FIELDS, 1, 1},
    },
    {NULL, 0, 0},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *protocol__msg__RecorderUnitEnum__get_individual_type_description_source(NULL),
    constructed = true;
  }
