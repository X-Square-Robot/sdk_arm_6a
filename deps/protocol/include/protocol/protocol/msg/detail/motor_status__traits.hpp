...
#ifndef PROTOCOL__MSG__DETAIL__MOTOR_STATUS__TRAITS_HPP_
#define PROTOCOL__MSG__DETAIL__MOTOR_STATUS__TRAITS_HPP_
...
inline void to_yaml(
  const protocol::msg::MotorStatus & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const protocol::msg::MotorStatus & msg)
{
  return protocol::msg::to_yaml(msg);
}

template<>
inline const char * data_type<protocol::msg::MotorStatus>()
{
  return "protocol::msg::MotorStatus";
}

template<>
inline const char * name<protocol::msg::MotorStatus>()
{
  return "protocol/msg/MotorStatus";
}

template<>
struct has_fixed_size<protocol::msg::MotorStatus>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<protocol::msg::MotorStatus>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<protocol::msg::MotorStatus>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // PROTOCOL__MSG__DETAIL__MOTOR_STATUS__TRAITS_HPP_
