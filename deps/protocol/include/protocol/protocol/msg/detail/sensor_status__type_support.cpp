...
{
  new (message_memory) protocol::msg::SensorStatus(_init);
}

void SensorStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<protocol::msg::SensorStatus *>(message_memory);
  typed_message->~SensorStatus();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember SensorStatus_message_member_array[2] = {
  {
    "state_code",  // name
    ...
    offsetof(protocol::msg::SensorStatus, state_code),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(protocol::msg::SensorStatus, error_bit_code),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SensorStatus_message_members = {
  ...
  2,  // number of fields
  sizeof(protocol::msg::SensorStatus),
...
get_message_type_support_handle<protocol::msg::SensorStatus>()
{
  return &::protocol::msg::rosidl_typesupport_introspection_cpp::SensorStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, protocol, msg, SensorStatus)() {
  return &::protocol::msg::rosidl_typesupport_introspection_cpp::SensorStatus_message_type_support_handle;
}
