...
#ifndef PROTOCOL__MSG__DETAIL__STATUS_CODE__FUNCTIONS_H_
#define PROTOCOL__MSG__DETAIL__STATUS_CODE__FUNCTIONS_H_
 ...
 * )) before or use
 * protocol__msg__StatusCode__create()
 ...
 * calls
 * protocol__msg__StatusCode__init().
...
/**
 * It calls
 * protocol__msg__StatusCode__fini()
 ...
 * protocol__msg__StatusCode__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * protocol__msg__StatusCode__Sequence__fini()
 * on the array,
...
#endif  // PROTOCOL__MSG__DETAIL__STATUS_CODE__FUNCTIONS_H_
