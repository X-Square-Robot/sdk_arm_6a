  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x38, 0x0a, 0xec, 0xbe, 0xda, 0xa6, 0x40, 0x04,
      0x85, 0xa1, 0x7f, 0x5f, 0x22, 0xe0, 0x03, 0x22,
      0xf1, 0xe8, 0xb2, 0x02, 0xcf, 0x45, 0x3f, 0x6a,
      0x69, 0x75, 0x44, 0xff, 0x1a, 0x7c, 0xc9, 0x9b,
    }};
  return &hash;
}
...
static char protocol__msg__NetMonitorUnitEnum__TYPE_NAME[] = "protocol/msg/NetMonitorUnitEnum";

// Define type names, field names, and default values
static char protocol__msg__NetMonitorUnitEnum__FIELD_NAME__structure_needs_at_least_one_member[] = "structure_needs_at_least_one_member";

static rosidl_runtime_c__type_description__Field protocol__msg__NetMonitorUnitEnum__FIELDS[] = {
  {
    {protocol__msg__NetMonitorUnitEnum__FIELD_NAME__structure_needs_at_least_one_member, 35, 35},
    {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {protocol__msg__NetMonitorUnitEnum__TYPE_NAME, 31, 31},
      {protocol__msg__NetMonitorUnitEnum__FIELDS, 1, 1},
    },
    {NULL, 0, 0},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *protocol__msg__NetMonitorUnitEnum__get_individual_type_description_source(NULL),
    constructed = true;
  }
