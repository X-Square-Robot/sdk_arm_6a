  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x70, 0xdc, 0xf9, 0xf8, 0x88, 0x05, 0xa3, 0xa2,
      0xe5, 0x78, 0x8f, 0x09, 0xb9, 0x44, 0xd3, 0xf3,
      0x3e, 0xca, 0x65, 0x1d, 0x79, 0xbf, 0x44, 0x90,
      0xfa, 0x5c, 0x03, 0x5a, 0xe2, 0x6d, 0x8b, 0xc9,
    }};
  return &hash;
}
...
static char protocol__msg__RightRmGripperUnitEnum__TYPE_NAME[] = "protocol/msg/RightRmGripperUnitEnum";

// Define type names, field names, and default values
static char protocol__msg__RightRmGripperUnitEnum__FIELD_NAME__structure_needs_at_least_one_member[] = "structure_needs_at_least_one_member";

static rosidl_runtime_c__type_description__Field protocol__msg__RightRmGripperUnitEnum__FIELDS[] = {
  {
    {protocol__msg__RightRmGripperUnitEnum__FIELD_NAME__structure_needs_at_least_one_member, 35, 35},
    {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {protocol__msg__RightRmGripperUnitEnum__TYPE_NAME, 35, 35},
      {protocol__msg__RightRmGripperUnitEnum__FIELDS, 1, 1},
    },
    {NULL, 0, 0},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *protocol__msg__RightRmGripperUnitEnum__get_individual_type_description_source(NULL),
    constructed = true;
  }
