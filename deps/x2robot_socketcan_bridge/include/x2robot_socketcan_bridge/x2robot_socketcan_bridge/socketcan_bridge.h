...
class SocketcanBridgeNode {
 ...
 private:
  ...
  std::map<std::string, rclcpp::Subscription<x2robot_msgs::msg::CanFrame>::SharedPtr> subscriptions_;
  ...
  void canPublisher(const x2robot_msgs::msg::CanFrame msg, const std::string& can_if);
