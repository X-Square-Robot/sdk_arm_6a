...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
  ...
  public:
    ...
    void declare_params(){
      ...
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "static_position_covariance") << ": " << param.get_type_name() << " = " << param.value_to_string());
      if(auto validation_result = fixed_size<double>(param, 9);
        !validation_result) {
      ...
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "read_covariance_from_interface") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.read_covariance_from_interface = param.as_bool();
