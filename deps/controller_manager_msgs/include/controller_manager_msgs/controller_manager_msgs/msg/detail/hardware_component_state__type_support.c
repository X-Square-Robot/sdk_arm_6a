...
static rosidl_typesupport_introspection_c__MessageMember controller_manager_msgs__msg__HardwareComponentState__rosidl_typesupport_introspection_c__HardwareComponentState_message_member_array[8] = {
  {
    "name",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(controller_manager_msgs__msg__HardwareComponentState, is_async),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(controller_manager_msgs__msg__HardwareComponentState, rw_rate),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(controller_manager_msgs__msg__HardwareComponentState, plugin_name),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, controller_manager_msgs, msg, HardwareComponentState)() {
  ...
  controller_manager_msgs__msg__HardwareComponentState__rosidl_typesupport_introspection_c__HardwareComponentState_message_member_array[6].members_ =
  ...
  controller_manager_msgs__msg__HardwareComponentState__rosidl_typesupport_introspection_c__HardwareComponentState_message_member_array[7].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, controller_manager_msgs, msg, HardwareInterface)();
