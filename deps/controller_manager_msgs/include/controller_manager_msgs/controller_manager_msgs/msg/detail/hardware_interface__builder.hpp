...
// IWYU pragma: private, include "controller_manager_msgs/msg/hardware_interface.hpp"
...
class Init_HardwareInterface_data_type
{
public:
  explicit Init_HardwareInterface_data_type(::controller_manager_msgs::msg::HardwareInterface & msg)
  : msg_(msg)
  {}
  Init_HardwareInterface_is_available data_type(::controller_manager_msgs::msg::HardwareInterface::_data_type_type arg)
  {
...
public:
  ...
  {}
  Init_HardwareInterface_data_type name(::controller_manager_msgs::msg::HardwareInterface::_name_type arg)
  {
    msg_.name = std::move(arg);
    return Init_HardwareInterface_data_type(msg_);
  }
