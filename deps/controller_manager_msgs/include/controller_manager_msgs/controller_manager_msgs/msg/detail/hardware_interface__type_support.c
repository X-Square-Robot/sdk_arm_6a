...
static rosidl_typesupport_introspection_c__MessageMember controller_manager_msgs__msg__HardwareInterface__rosidl_typesupport_introspection_c__HardwareInterface_message_member_array[4] = {
  {
    "name",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(controller_manager_msgs__msg__HardwareInterface, data_type),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
