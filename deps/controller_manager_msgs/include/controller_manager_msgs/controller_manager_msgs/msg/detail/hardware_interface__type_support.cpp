...
static const ::rosidl_typesupport_introspection_cpp::MessageMember HardwareInterface_message_member_array[4] = {
  {
    "name",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(controller_manager_msgs::msg::HardwareInterface, data_type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
