...
- `/cart_pose_controller/pose_cmd` - 任务空间位姿命令 (`geometry_msgs/PoseStamped`)
- `/gripper_controller/commands` - 夹爪命令 (`std_msgs/Float64MultiArray`)
...
- **任务空间**: 位置使用线性插值 + TOPP-RA，方向使用 SLERP 进行四元数插值
